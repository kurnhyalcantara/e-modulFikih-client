...
const OurFeature = () => {
  ...
  return (
    <Box className="our-feature">
      <Typography className="title-container" color={theme.palette.primary.main}>
        FITUR KAMI
      </Typography>
      <Typography
        variant="h4"
      ...
      <Typography variant="p" color={theme.palette.text.secondary} className="description-feature">
              ...
              <Grid item xs={12} md={4} key={index}>
                <Card variant="outlined" className="card-style">
                  <CardContent className="card-feature">
                    {feature.image}
                    <Typography variant="h5" fontWeight={700} textAlign="center" paddingY={2}>
                      {feature.title}
                    </Typography>
                    <Typography variant="p" color={theme.palette.text.secondary} textAlign="center">
                      {feature.description}
                    </Typography>
                  </CardContent>
                </Card>
